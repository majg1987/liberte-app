...
Revision ID: b55dbb89f815
Revises: 
Create Date: 2022-07-10 18:34:02.354703
...
def upgrade():
    ...
    sa.Column('foto_usuario', sa.String(length=50), nullable=True),
